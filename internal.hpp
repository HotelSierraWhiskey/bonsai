...
// #define BYTES_ALLOCATED (BONSAI_MEMORY_END - BONSAI_MEMORY_START)
// #define NUMBER_OF_PAGES (BYTES_ALLOCATED / PAGE_SIZE)

#define SYSTEM_PROPERTIES_ROW_ADDRESS BONSAI_MEMORY_START
#define ROOT_DIRECTORY_ADDRESS (SYSTEM_PROPERTIES_ROW_ADDRESS + ROW_SIZE)
